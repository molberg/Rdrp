...
int readODINscan(const char *name, Scan *s)
{
    ...
    if (sc != NULL) {
        ...
        m = fread((char *)&(s->Version), sizeof(uint16_t),    1, sc);
        l += m*sizeof(uint16_t);
        m = fread((char *)&(s->Level), sizeof(uint16_t),      1, sc);
        l += m*sizeof(uint16_t);
        m = fread((char *)&(s->Quality), sizeof(uint32_t),    1, sc);
        l += m*sizeof(uint32_t);
        m = fread((char *)&(s->STW), sizeof(uint32_t),        1, sc);
        l += m*sizeof(uint32_t);
        m = fread((char *)&(s->MJD), sizeof(double),        1, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->Orbit), sizeof(double),      1, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->LST), sizeof(float),        1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->Source), sizeof(char), SOURCENAMELEN, sc);
        l += m*sizeof(char);
        m = fread((char *)&(s->Discipline), sizeof(int16_t), 1, sc);
        l += m*sizeof(int16_t);
        m = fread((char *)&(s->Topic), sizeof(int16_t),      1, sc);
        l += m*sizeof(int16_t);
        m = fread((char *)&(s->Spectrum), sizeof(int16_t),   1, sc);
        l += m*sizeof(int16_t);
        m = fread((char *)&(s->ObsMode), sizeof(int16_t),    1, sc);
        l += m*sizeof(int16_t);
        m = fread((char *)&(s->Type), sizeof(int16_t),       1, sc);
        l += m*sizeof(int16_t);
        m = fread((char *)&(s->Frontend), sizeof(int16_t),   1, sc);
        l += m*sizeof(int16_t);
        m = fread((char *)&(s->Backend), sizeof(int16_t),    1, sc);
        l += m*sizeof(int16_t);
        m = fread((char *)&(s->SkyBeamHit), sizeof(int16_t), 1, sc);
        l += m*sizeof(int16_t);
        m = fread((char *)&(s->RA2000), sizeof(float),     1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->Dec2000), sizeof(float),    1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->VSource), sizeof(float),    1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->u.map.Xoff), sizeof(float), 1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->u.map.Yoff), sizeof(float), 1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->u.map.Tilt), sizeof(float), 1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->Qtarget), sizeof(double),    4, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->Qachieved), sizeof(double),  4, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->Qerror), sizeof(double),     3, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->GPSpos), sizeof(double),     3, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->GPSvel), sizeof(double),     3, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->SunPos), sizeof(double),     3, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->MoonPos), sizeof(double),    3, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->SunZD), sizeof(float),      1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->Vgeo), sizeof(float),       1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->Vlsr), sizeof(float),       1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->Tcal), sizeof(float),       1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->Tsys), sizeof(float),       1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->SBpath), sizeof(float),     1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->LOFreq), sizeof(double),     1, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->SkyFreq), sizeof(double),    1, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->RestFreq), sizeof(double),   1, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->MaxSuppression), sizeof(double), 1, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->SodaVersion), sizeof(double), 1, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->FreqRes), sizeof(double),    1, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->FreqCal), sizeof(double),    4, sc);
        l += m*sizeof(double);
        m = fread((char *)&(s->IntMode), sizeof(int32_t),    1, sc);
        l += m*sizeof(int32_t);
        m = fread((char *)&(s->IntTime), sizeof(float),    1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->EffTime), sizeof(float),    1, sc);
        l += m*sizeof(float);
        m = fread((char *)&(s->Channels), sizeof(int32_t),   1, sc);
        l += m*sizeof(int32_t);
...
int writeODINscan(char *name, Scan *s)
{
    ...
    if (sc != NULL) {
        ...
        m = fwrite((char *)&(s->Version), sizeof(uint16_t),    1, sc);
        l += m*sizeof(uint16_t);
        m = fwrite((char *)&(s->Level), sizeof(uint16_t),      1, sc);
        l += m*sizeof(uint16_t);
        m = fwrite((char *)&(s->Quality), sizeof(uint32_t),    1, sc);
        l += m*sizeof(uint32_t);
        m = fwrite((char *)&(s->STW), sizeof(uint32_t),        1, sc);
        l += m*sizeof(uint32_t);
        m = fwrite((char *)&(s->MJD), sizeof(double),        1, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->Orbit), sizeof(double),      1, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->LST), sizeof(float),        1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->Source), sizeof(char), SOURCENAMELEN, sc);
        l += m*sizeof(char);
        m = fwrite((char *)&(s->Discipline), sizeof(int16_t), 1, sc);
        l += m*sizeof(int16_t);
        m = fwrite((char *)&(s->Topic), sizeof(int16_t),      1, sc);
        l += m*sizeof(int16_t);
        m = fwrite((char *)&(s->Spectrum), sizeof(int16_t),   1, sc);
        l += m*sizeof(int16_t);
        m = fwrite((char *)&(s->ObsMode), sizeof(int16_t),    1, sc);
        l += m*sizeof(int16_t);
        m = fwrite((char *)&(s->Type), sizeof(int16_t),       1, sc);
        l += m*sizeof(int16_t);
        m = fwrite((char *)&(s->Frontend), sizeof(int16_t),   1, sc);
        l += m*sizeof(int16_t);
        m = fwrite((char *)&(s->Backend), sizeof(int16_t),    1, sc);
        l += m*sizeof(int16_t);
        m = fwrite((char *)&(s->SkyBeamHit), sizeof(int16_t), 1, sc);
        l += m*sizeof(int16_t);
        m = fwrite((char *)&(s->RA2000), sizeof(float),     1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->Dec2000), sizeof(float),    1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->VSource), sizeof(float),    1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->u.map.Xoff), sizeof(float), 1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->u.map.Yoff), sizeof(float), 1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->u.map.Tilt), sizeof(float), 1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->Qtarget), sizeof(double),    4, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->Qachieved), sizeof(double),  4, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->Qerror), sizeof(double),     3, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->GPSpos), sizeof(double),     3, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->GPSvel), sizeof(double),     3, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->SunPos), sizeof(double),     3, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->MoonPos), sizeof(double),    3, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->SunZD), sizeof(float),      1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->Vgeo), sizeof(float),       1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->Vlsr), sizeof(float),       1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->Tcal), sizeof(float),       1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->Tsys), sizeof(float),       1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->SBpath), sizeof(float),     1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->LOFreq), sizeof(double),     1, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->SkyFreq), sizeof(double),    1, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->RestFreq), sizeof(double),   1, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->MaxSuppression), sizeof(double), 1, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->SodaVersion), sizeof(double), 1, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->FreqRes), sizeof(double),    1, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->FreqCal), sizeof(double),    4, sc);
        l += m*sizeof(double);
        m = fwrite((char *)&(s->IntMode), sizeof(int32_t),    1, sc);
        l += m*sizeof(int32_t);
        m = fwrite((char *)&(s->IntTime), sizeof(float),    1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->EffTime), sizeof(float),    1, sc);
        l += m*sizeof(float);
        m = fwrite((char *)&(s->Channels), sizeof(int32_t),   1, sc);
        l += m*sizeof(int32_t);
